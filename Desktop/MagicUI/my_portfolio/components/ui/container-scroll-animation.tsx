  ...
  return (
    <motion.div
      style={{
        ...
        scale,
        boxShadow:
          "0 0 #0000004d, 0 9px 10px #0000004a, 0 20px 20px #00000042, 0 84px 50px #00000026, 0 149px 60px #0000000a, 0 233px 65px #00000003",
      }}
    ...
    >
      <div className=" h-full w-full  overflow-hidden rounded-2xl bg-gray-200 dark:bg-zinc-900 md:rounded-2xl md:p-2 ">
        {children}
      </div>
    </motion.div>
  );
